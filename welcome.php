...
<body bgcolor="#FAF9F6">
  <div class="nav-wrapper">
    ...
    <nav>
      <a href="http://localhost/ditto/admin/addusers.php">ADD USER</a>
      ...
      <a href="http://localhost/ditto/admin/dashboard.php" style="text-transform:uppercase"><?php echo htmlspecialchars($username); ?></a>
      <span></span>
    </nav>
  </div>
